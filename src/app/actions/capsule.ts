...
// import { redirect } from "next/navigation"; // Not used anymore
...
export async function createCapsule(formData: FormData) {
  ...
  const message = formData.get("message") as string; // Get message
  ...
  try {
    ...
    // 4. SEND EMAIL
    const emailCommand = new SendEmailCommand({
      Source: "manideep17072004@gmail.com", // REPLACE WITH YOUR VERIFIED EMAIL
      Destination: {
